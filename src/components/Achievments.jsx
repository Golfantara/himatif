...
const Achievments = () => {
  ...
  return (
    <div className="container mx-auto">
      <div
        className="bg-[#020181] w-[130px] h-[50px] mb-10 rounded-md flex justify-center items-center max-[500px]:w-[100px] ml-20"
        data-aos="fade-right"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 w-[80vw] ml-24">
        {images.map((image) => (
          <div
            key={image.id}
          ...
          >
            <img
              className="aspect-[4/3] object-cover rounded-lg shadow-md cursor-pointer w-[25vw]"
              src={image.src}
              alt={image.src}
              ...
              data-aos-once="true"
            />
            <p className="z-50 absolute bg-black opacity-60 text-white p-2 mb-2 rounded-lg">
              {image.caption}
            </p>
          </div>
        ))}
